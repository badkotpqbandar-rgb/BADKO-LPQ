...
// --- ENTRY POINT UNTUK PREVIEW ---
// Menambahkan default export App agar lingkungan pratinjau bisa merender komponen
export default function App() {
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-center p-8">
      <h3 className="text-xl font-bold text-slate-700 mb-6 uppercase tracking-widest">Preview ID Card</h3>
      <IDCardPrintBox />
    </div>
  );
}
